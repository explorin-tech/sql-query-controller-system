module.exports = Object.freeze({
  ...
  EDIT_A_DATABASE_MAPPING: `UPDATE "DataBaseApplicationMapping" SET "DBAM_MA_ID" = $2 , "DBAM_MA_Name" = $3, "DBAM_DBName" = $4, "DMAM_DBT_ID"=$5, "DMAM_DBT_Name"=$6, "DBAM_DBConnectionString"= $7, "DBAM_DBPortNumber"=$8 , "DBAM_DBHostName"= $9, "DBAM_DBPassword" = $10, "DBAM_UpdatedOn"= NOW(), "DBAM_UpdatedBy"=$11 WHERE "DBAM_ID"=$1`,
});
