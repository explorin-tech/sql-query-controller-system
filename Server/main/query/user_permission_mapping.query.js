module.exports = Object.freeze({
  GET_ALL_USER_PERMISSION_MAPPINGS_FOR_AN_USER:
    'SELECT * FROM "UserPermission" LEFT JOIN "DataBaseApplicationMapping" ON "DataBaseApplicationMapping"."DBAM_ID" = "UserPermission"."UP_DBAM_ID"  LEFT JOIN "MasterApplication" ON "DataBaseApplicationMapping"."DBAM_MA_ID" = "MasterApplication"."MA_ID" LEFT JOIN "MasterDatabase" ON "DataBaseApplicationMapping"."DBAM_MD_ID" = "MasterDatabase"."MD_ID" LEFT JOIN "DataBaseType" ON "DataBaseType"."DBT_ID" = "MD_DBT_ID" WHERE "UserPermission"."UP_U_ID" = $1 ORDER BY "UserPermission"."UP_AddedOn" DESC;',
  GET_ALL_USER_PERMISSION_MAPPINGS_FOR_A_USER_ACCORDING_TO_ACCESS_RIGHTS:
    'SELECT * FROM "UserPermission" LEFT JOIN "DataBaseApplicationMapping" ON "DataBaseApplicationMapping"."DBAM_ID" = "UserPermission"."UP_DBAM_ID"  LEFT JOIN "MasterApplication" ON "DataBaseApplicationMapping"."DBAM_MA_ID" = "MasterApplication"."MA_ID" LEFT JOIN "MasterDatabase" ON "DataBaseApplicationMapping"."DBAM_MD_ID" = "MasterDatabase"."MD_ID" LEFT JOIN "DataBaseType" ON "DataBaseType"."DBT_ID" = "MD_DBT_ID" WHERE "UserPermission"."UP_U_ID" = $1 AND "UserPermission"."UP_DBAM_ID" IN (SELECT DISTINCT "UserPermission"."UP_DBAM_ID" FROM "UserPermission" WHERE "UserPermission"."UP_U_ID" = $2 AND "UserPermission"."UP_RightToRead" = TRUE) ORDER BY "UserPermission"."UP_AddedOn" DESC;',
