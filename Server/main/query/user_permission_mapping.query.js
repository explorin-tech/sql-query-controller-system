module.exports = Object.freeze({
  ...
  INSERT_USER_PERMISSION_RIGHTS_MAPPINGS_FOR_AN_USER:
    'INSERT INTO "UserPermission"("UP_U_ID" , "UP_DBAM_ID" , "UP_RightToRead", "UP_RightToCreate", "UP_RightToInsert", "UP_RightToUpdate", "UP_RightToDelete", "UP_AddedOn", "UP_AddedBy", "UP_UpdatedOn", "UP_UpdatedBy") VALUES ($1, $2, $3, $4, $5, $6, $7, NOW(), $8, NOW(), $9);',
  UPDATE_USER_PERMISSION_RIGHTS_MAPPINGS_FOR_AN_USER:
    'UPDATE "UserPermission" SET "UP_RightToRead" = $3, "UP_RightToCreate" = $4, "UP_RightToInsert" = $5, "UP_RightToUpdate" = $6, "UP_RightToDelete" = $7, "UP_UpdatedOn" = NOW() , "UP_UpdatedBy" = $8 WHERE "UserPermission"."UP_U_ID"=$1 AND "UserPermission"."UP_DBAM_ID"=$2;',
});
