module.exports = Object.freeze({
    SELECT_ALL_MASTER_APPLICATIONS: 'SELECT * FROM "MasterApplication" ORDER BY "MA_AddedOn" DESC',
    ...
    GET_ALL_DATABASES: `SELECT * from "DataBaseApplicationMapping" ORDER BY "DBAM_AddedOn" DESC`
});
