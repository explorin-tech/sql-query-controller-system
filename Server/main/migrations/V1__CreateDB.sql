CREATE TABLE "UserType"(
	...
	"UT_Name" VARCHAR(2) UNIQUE NOT NULL
);
...
CREATE TABLE "MasterApplication"(
	...
	"MA_Name" VARCHAR(200) UNIQUE NOT NULL,
...
INSERT INTO "QueryStatus"("QS_Name") VALUES('HOLD_FOR_APPROVAL');
INSERT INTO "QueryStatus"("QS_Name") VALUES('SET_FOR_APPROVAL');
...
We now need to assign an admin user -- 
{
	"user": {
		...
		"password": "jai2201@2004",
		"user_type_id": 1,
		"is_active": 1,
		"is_active_direct_user": false
	}
}
